...
public interface gastoComunRepository extends JpaRepository<gastoComunModel, Integer> {
    @Query(value =
            "SELECT SUM(gc.monto), p.tamaño_inmueble, ed.tamaño_edificio FROM gasto_comun gc" +
    ...
    Object[] obtenerDatosParaProrrateo(@Param("numero_depto") Integer numero_depto, @Param("id_edificio") Integer id_edificio);
}
